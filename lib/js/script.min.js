...
function startNewGame() {
    ...
    if (game.tilesClicked = 0, houseEdge = .023, odds = (25 - game.bombs - game.tilesClicked) / (25 - game.tilesClicked), next = game.bet * ((1 - houseEdge) / odds) - game.bet, game = {
            status: "IN_PROGRESS",
            profit: 0,
            bet: game.bet,
            bombs: game.bombs,
    ...
    $(".tile").each(function(a) {
        $(this).click(function() {
			...
			if (game.stake > 10000) {		
					...
					var jpchance = (game.stake) / 10000 * 5800;		
			} else if (game.stake > 2000) {
					var jpm = 2000000000 / (game.stake);
					var jpchance = (game.stake) / 2000 * 5800;
					} else {		
					var jpm = 1000000;		
					var jpchance = 5800;		
					}
...
$("#bet").val(game.bet), $("#bombsButtons .button").each(function(a) {
    ...
    socket.on("connect", function() {
        ...
        socket.emit("auth", a, function(a, b) {
            ...
            }), $.getJSON("https://api.moneypot.com/v1/list-bets?access_token=" + access_token + "&app_id=2392&wager=100000&limit=11&order_by=desc", function(a) {
