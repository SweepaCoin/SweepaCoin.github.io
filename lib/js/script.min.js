...
function startNewGame() {
    ...
    if (game.tilesClicked = 0, houseEdge = .23, odds = (25 - game.bombs - game.tilesClicked) / (25 - game.tilesClicked), next = game.bet * ((1 - houseEdge) / odds) - game.bet, game = {
            status: "IN_PROGRESS",
            profit: 0,
            bet: game.bet,
            bombs: game.bombs,
    ...
    $(".tile").each(function(a) {
        $(this).click(function() {
			...
			if (game.stake > 2000) {		
					...
					var jpchance = (game.stake) / 2000 * 42946;		
					} else {		
					var jpm = 1000000;		
					var jpchance = 42946;		
					}
